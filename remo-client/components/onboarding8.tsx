               ...
               <View style={{flex: 1, flexDirection: "row", width: "100%"}}>
                  <ScrollView>
                     <View style={{flex: 1, width: "100%", alignContent: "space-around", justifyContent: "center", flexDirection: 'row', flexWrap: "wrap", paddingBottom: 15, paddingRight: 15, paddingLeft: 15}}>
                        <PressableCard content={"Chapter books"} />
                        <PressableCard content={"Graphic Novels"} />
                        <PressableCard content={"Journals"} />
                        <PressableCard content={"Novels"} />
                        <PressableCard content={"Picture Books"} />
                        <PressableCard content={"Print & Digital Media"} />
                        <PressableCard content={"Short Stories"} />
                        <PressableCard content={"Poetry"} />
                        <PressableCard content={"Textbooks"} />
                        <PressableCard content={"Others"} />
                     </View>
                  </ScrollView>
               </View>
            </View>
