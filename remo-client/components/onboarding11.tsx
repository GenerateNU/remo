         ...
         <View style={{
          ...
          justifyContent: "center",
            ...
            <View style={styles.block}>
               <Text style={styles.question}>What are your biggest obstacles for reading?</Text>
               <View style={{flex: 1, flexDirection: "row", width: "100%"}}>
                  <ScrollView>
                     <View style={{flex: 1, width: "100%", alignContent: "space-around", justifyContent: "center", flexDirection: 'row', flexWrap: "wrap", paddingBottom: 15, paddingRight: 15, paddingLeft: 15}}>
                        <PressableCard content={"Book topics"} />
                        <PressableCard content={"Book access"} />
                        <PressableCard content={"Time"} />
                        <PressableCard content={"Motivation"} />
                        <PressableCard content={"Disability"} />
                        <PressableCard content={"Other"} />
                     </View>
                  </ScrollView>
               </View>
            </View>
